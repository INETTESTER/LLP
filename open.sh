...
##########################################################################
                     API="withdrawal" 
                     google_sheet="https://docs.google.com/spreadsheets/d/1lmHM0MZmz3KO7-UHtuym-aKtLy5e5KWzYLuUB2AGE7k/edit?gid=158997130#gid=158997130" 
                     id="7"                 #เปลี่ยน id ทุกครั้งที่ยิง
                     user="17000";            #จำนวนผู้ใช้งาน
                     duration="180";         #วินาที
